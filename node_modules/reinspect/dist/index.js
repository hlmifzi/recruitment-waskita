...
var StateInspectorContext = React__default.createContext(null);
...
var StateInspector = function (_a) {
    ...
    return (React__default.createElement(StateInspectorContext.Provider, { value: store }, children));
};
...
function useReducer(reducer, initialState) {
    ...
    return store || !id
        ...
        : React.useReducer(reducer, initialState, initializer);
}
...
var useState = function (initialState, id) {
    var inspectorStore = React.useContext(StateInspectorContext);
    var _a = React.useMemo(function () { return [inspectorStore, id]; }, []), store = _a[0], reducerId = _a[1];
    if (!store || !reducerId) {
