        ...
        <div className="d-flex mt-48">
          <div className="container-step">
            ...
            <div className="wrapper-image-circle">
              <img alt="picture2" src={instagramIcon} />
            </div>
          </div>
          <div className="container-step">
          ...
          <div className="container-step">
            <div className="label-step"><span className="mr-6">6</span>Tunggu</div>
          ...
          <div className="container-step">
            <div className="label-step"><span className="mr-6">7</span>Click</div>
